...
const isOk = R.compose(
  R.contains(R.__, STATUS_SUCCESS)
, getStatusCode
)


const getBodyOrThrowError = R.ifElse(
  isOk
, getBody
, (res) => { throw new CouchDBError(res) }
)
...
, getBodyOrThrowError: getBodyOrThrowError
}
